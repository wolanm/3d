...
#define HOMING_BACKOFF_MM { 6, 5, 2 }  // (mm) Move away from the endstops after homing
...
#define LCD_TIMEOUT_TO_STATUS 100 * 60 * 3
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    #define X_CURRENT_HOME  X_CURRENT - 350  // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT_HOME  Y_CURRENT - 350
    #define Y_MICROSTEPS     16
